      ...
      <div className="mx-auto max-w-5xl flex flex-col gap-10">
        ...
        <section className="space-y-4">
          ...
          <div className="flex flex-col gap-3 text-base">
            ...
            >
              <FaTelegramPlane className="text-xl" /> Telegram: https://t.me/vutrung
            </a>
            <a
            ...
            <a
              ...
              className="flex items-center gap-2 bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded-lg w-fit"
            >
              <FaTiktok className="text-xl" /> Tiktok: tiktok.com/@VuTrung
            </a>
            <a
